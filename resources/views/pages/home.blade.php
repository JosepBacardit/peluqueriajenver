...
<script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "@id": "https://www.peluqueriajenver.com/#business",
  "name": "Peluquería Jenver",
  "image": "{{ asset('images/logo-jenver.png') }}",
  "description": "Peluquería unisex especializada en balayage, cabello afro, rizos y servicios de belleza integral en Montcada i Reixac, Barcelona.",
  "url": "{{ url('/') }}",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Cuál es el horario de Peluquería Jenver?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Abierto de martes a sábado, de 9:00 a 19:00. Cerrado lunes y domingo."
      }
    },
    {
      "@type": "Question",
      "name": "¿Dónde está ubicada Peluquería Jenver?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "C/ Lleida, 21, 08110 Montcada i Reixac, Barcelona. Acceso fácil desde la zona norte de Barcelona."
      }
    },
    {
      "@type": "Question",
      "name": "¿Hacéis diagnóstico gratuito?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sí, siempre realizamos un diagnóstico gratuito antes de cualquier servicio para asegurar los mejores resultados."
      }
    },
    {
      "@type": "Question",
      "name": "¿Cómo puedo reservar una cita?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Puedes reservar llamando al 633 912 050 o enviándonos un mensaje por WhatsApp. También aceptamos reservas por teléfono."
      }
    }
  ]
}

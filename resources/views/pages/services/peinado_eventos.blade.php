...
@section('meta_description', 'Peinados para bodas, recogidos y eventos en Montcada i Reixac. Prueba previa incluida. Diseño exclusivo para tu día especial.')
...
<!-- SECTION 1: Hero -->
<section class="relative w-full h-screen md:h-[90vh] bg-cover bg-center flex items-center justify-center" style="background-image: url('{{ asset('images/peinados-para-eventos.png') }}');">
...
<section class="bg-[#0A0A0A] py-16 md:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('belleza-estetica') }}" class="bg-[#1A1A1A] border border-[#2A2A2A] hover:border-gold/50 transition-colors p-8 group">
                <div class="text-4xl mb-4">💅</div>
                <h3 class="font-serif text-xl font-bold text-white mb-3 group-hover:text-gold transition-colors">Belleza y Estética</h3>
                <p class="text-gray-400 text-sm mb-4">Manicura, pedicura, cejas y depilación facial en un solo lugar.</p>
                <span class="text-gold text-sm font-semibold">Ver servicios →</span>
            </a>
        </div>
    </div>
